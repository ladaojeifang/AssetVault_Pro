...
const TYPE_STYLES = {
  success: {
    accent: 'bg-av-status-success',
    iconWrap: 'bg-av-status-success-muted-bg text-av-status-success-muted-text ring-av-status-success/25',
    icon: (
  ...
  error: {
    accent: 'bg-av-status-error',
    iconWrap: 'bg-av-status-error-muted-bg text-av-status-error-muted-text ring-av-status-error/25',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25">
  ...
  warning: {
    accent: 'bg-av-status-warning',
    iconWrap: 'bg-av-status-warning-muted-bg text-av-status-warning-muted-text ring-av-status-warning/25',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25">
  ...
  info: {
    ...
    iconWrap: 'bg-av-status-info-muted-bg text-av-status-info-muted-text ring-av-accent-blue/25',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25">
        <circle cx="12" cy="12" r="10" />
