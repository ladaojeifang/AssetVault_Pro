...
export const THEME_CATALOG: Record<ThemeId, ThemeTokenSet> = {
  dark: {
    ...
    textMuted: '#707E94',
    accentBlue: '#FF9F1C',
    accentBlueHover: '#E89010',
    accentBluePressed: '#D47F00',
    accentPurple: '#8B5CF6',
    accentGreen: '#10B981',
    accentOrange: '#FF9F1C',
    accentRed: '#E06C75',
    border: '#222831',
    borderLight: '#2A3140',
    scrollbarThumb: '#2A3140',
    scrollbarThumbHover: '#3A4255',
    selectionBg: 'rgba(255, 159, 28, 0.22)',
    selectionText: '#F0F2F5',
    shadowModal: 'rgba(0, 0, 0, 0.55)',
    arcoMessageBg: '#1E222D',
    statusSuccess: '#10B981',
    statusSuccessMutedBg: 'rgba(16, 185, 129, 0.15)',
    statusSuccessMutedText: '#34D399',
    statusError: '#E06C75',
    statusErrorMutedBg: 'rgba(224, 108, 117, 0.12)',
    statusErrorMutedText: '#E06C75',
    statusWarning: '#FF9F1C',
    statusWarningMutedBg: 'rgba(255, 159, 28, 0.12)',
    statusWarningMutedText: '#FFB84D',
    statusInfoMutedBg: 'rgba(255, 159, 28, 0.12)',
    statusInfoMutedText: '#FFB84D',
    ...
    errorBoundaryBg: '#0D0F14',
    errorBoundaryText: '#E06C75',
    errorBoundaryDetail: '#F08A93'
  },
  light: {
    bgPrimary: '#F1F5F9',
    bgSecondary: '#FFFFFF',
